        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="ten_km" name="ten_km" autofocus required>
            </div>
            <div class="mb-3">
              <label class="form-label" for="start">Ngày bắt đầu:<span class="text-danger">*</span></label>
              <input type="date" class="form-control" name="ngay_bat_dau" id="start" required>
            </div>
            <div class="mb-3">
              <label class="form-label" for="end">Ngày kết thúc:<span class="text-danger">*</span></label>
              <input type="date" class="form-control" name="ngay_ket_thuc" id="end" required>
            </div>
          </div>
          <div class="col">
            <div class="mb-3">
              <label for="giam_gia" class="form-label">Giảm giá(%):<span class="text-danger">*</span></label>
              <input type="number" class="form-control" id="giam_gia" name="giam_gia" required>
            </div>
            <div class="mb-3">
              <label for="description" class="form-label">Mô tả:</label>
              <textarea type="text" class="form-control" id="description" name="mo_ta" rows="4"></textarea>
            </div>
          </div>
        </div>
