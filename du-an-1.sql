...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2024 at 10:55 AM
...
(8, 'DH1712199127', '2024-04-04 09:52:07', 1, 1, 7, 0, 13000000, '', 'Admin', 'admin@gmail.com', '0339735022', 'Hà Nội'),
(9, 'DH1712199360', '2024-04-04 09:56:00', 10, 1, 3, 0, 13000000, '', 'Client', 'client@gmail.com', '0339735555', 'Hải Phòng'),
(10, 'DH1712204478', '2024-04-04 11:21:18', 10, 1, 3, 0, 23920000, '', 'Client', 'client@gmail.com', '0339735555', 'Hải Phòng'),
(11, 'DH1712216348', '2024-04-04 14:39:08', 1, 1, 6, 0, 48800000, 'abc', 'Admin', 'admin@gmail.com', '0339735022', 'Hà Nội');
...
(16, 'Xiaomi Redmi Note 13 6GB 128GB', 4890000, 4690000, 16, 'Redmi Note 13 sở hữu những nâng cấp đáng chú ý với con chip Snapdragon 685, GPU Mali-G57 cùng 6GB RAM để có thể cải thiện tới 25% hiệu năng và 35% khả năng hiển thị đồ hoạ. Điện thoại cũng sẽ được trang bị màn hình AMOLED 120Hz để có được khả năng hiển thị cùng với đó là viên pin 5000 mAh với công suất sạc 33W.', '2024-04-04', 100, 1),
(17, 'iPhone 15 Pro Max 256GB', 34990000, 31990000, 5, 'iPhone 15 Pro Max thiết kế mới với chất liệu titan chuẩn hàng không vũ trụ bền bỉ, trọng lượng nhẹ, đồng thời trang bị nút Action và cổng sạc USB-C tiêu chuẩn giúp nâng cao tốc độ sạc. Khả năng chụp ảnh đỉnh cao của iPhone 15 bản Pro Max đến từ camera chính 48MP, camera UltraWide 12MP và camera telephoto có khả năng zoom quang học đến 5x. Bên cạnh đó, iPhone 15 ProMax sử dụng chip A17 Pro mới mạnh mẽ. Xem thêm chi tiết những điểm nổi bật của sản phẩm qua thông tin sau!', '2024-04-04', 100, 1),
